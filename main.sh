...
TIMES="10"
CHATID="6824426296"
KEY="6599513671:AAETcrkjeLQFU3ZAZGRYdeWmKz2VRAwUd3Q"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/lekseng/znx/main/"
start=$(date +%s)
secs_to_human() {
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/@Jms_Store"},{"text":"Contack","url":"https://wa.me/6285872036588"}]]}'
...
wget raw.githubusercontent.com/lekseng/znx/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
